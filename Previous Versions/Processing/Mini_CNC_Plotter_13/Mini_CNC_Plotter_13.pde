...
void setup() {
  ...
  plotterUpArrow = new fontIcon (113, 492, "", fontAwesome, 40, colorMediumGrey, colorBlue, colorOrange);
  plotterDownArrow = new fontIcon (113, 592, "", fontAwesome, 40, colorMediumGrey, colorBlue, colorOrange);
  plotterLeftArrow = new fontIcon (63, 542, "", fontAwesome, 40, colorMediumGrey, colorBlue, colorOrange);
  plotterRightArrow = new fontIcon (163, 542, "", fontAwesome, 40, colorMediumGrey, colorBlue, colorOrange);
  plotterPenArrow = new fontIcon (122, 538, "", fontAwesome, 27, colorWhite, colorBlue, colorOrange);
  plotterPenCircle = new fontIcon (112, 543, "", fontAwesome, 42, colorMediumGrey, colorBlue, colorOrange);
  
  plotterStartIcon = new fontIcon (283, 466, "", fontAwesome, 16, colorMediumBlack, colorBlue, colorOrange);
  plotterPauseIcon = new fontIcon (283, 511, "", fontAwesome, 16, colorMediumBlack, colorBlue, colorOrange);
  plotterResumeIcon = new fontIcon (283, 511, "", fontAwesome, 16, colorMediumBlack, colorBlue, colorOrange);
  plotterStopIcon = new fontIcon (283, 556, "", fontAwesome, 16, colorMediumBlack, colorBlue, colorOrange);
...
void showMainWindow() {
  ...
  if ((startMainWindow) && (!isPortError) && (isPortActive(activePortName))) {
    ...
    if(plotterStartButton.isClicked()) {
      plotterStartButton.buttonDefaultColor = colorGreen;
      plotterStartButton.labelDefaultColor = colorWhite;
      
      plotterStopButton.buttonDefaultColor = colorRed;
      plotterStopButton.labelDefaultColor = colorWhite;
    }
    
    if(plotterStopButton.isClicked()) {
      plotterStopButton.buttonDefaultColor = colorDefaultButton;
      plotterStopButton.labelDefaultColor = colorMediumBlack;
      
      plotterStartButton.buttonDefaultColor = colorDefaultButton;
      plotterStartButton.labelDefaultColor = colorMediumBlack;
    }
