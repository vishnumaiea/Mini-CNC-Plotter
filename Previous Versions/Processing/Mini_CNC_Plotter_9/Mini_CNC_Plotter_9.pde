...
//   -- Mini CNC Plotter - 09 --
//
//   Finally ! After lots of painstaking effort I was able to implement
//   serial port selection and monitoring the best way I could, just
//   I imagined it. The active() function for serial port was actually
//   not working. It always retured true even if I disconnected the
//   device. So I ditched it and implemented a function to check if
//   the selected active port is available in the serial port list.
//   I tried to implement this before but did something wrng there.
//   I used '==' to check if two strings are equal which is not the 
//   way to do that. Then I relaised that I have to use 'equals()'
//   function to do that. Now I have self contained serial port
//   monitoring function which will return false if the port gets
//   disconnected. I was able to implement this only becasue the serial
//   list function always return all the ports regardless of they are
...
//   Last modified : 2:14 PM 02-05-2017, Tuesday
...
uiButton plotterUpButton = new uiButton (100, 100, 150, 130, "My Button", 220, #006699, 50, 250);
uiButton plotterDownButton = new uiButton (100, 100, 150, 130, "My Button", 220, #006699, 50, 250);
uiButton plotterLeftButton = new uiButton (100, 100, 150, 130, "My Button", 220, #006699, 50, 250);
uiButton pplotterRightButton = new uiButton (100, 100, 150, 130, "My Button", 220, #006699, 50, 250);
uiButton plotterPenButton = new uiButton (100, 100, 150, 130, "My Button", 220, #006699, 50, 250);
