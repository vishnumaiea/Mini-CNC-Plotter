...
//   -- Mini CNC Plotter - 20 ---
//
//   I've completed implementing the line drawing algorithm and the comma
//   protocol successfully. Now I have to implement the calibrate functions
//   and buttons.
//
...
//   Last modified : 04:54:18 PM, 27-05-2017, Saturday
          ...
          if ((ifLines) && (!isPlottingFinished) && (isCurrentPortActive()) && (!ifStopPlotter)) {
            if (currentSegment > lineCount) { //check if finished plotting all lines
              ...
              if ((!waitingForResponse) && (!ifStopPlotter)) {
                if (((coordinateType == COORD_TYPE_END) || (coordinateType == COORD_TYPE_NONE)) && (!isPenDown)) { //check what type of coordiante was sent last. 2 = end, 1 = start
                  println();
                ...
                else if((coordinateType == COORD_TYPE_START) && (!isPenDown)) { //if start coordinates have been sent
                ...
                else if ((coordinateType == COORD_TYPE_DOWN) && (isPenDown)) { //check what type of coordiante was sent last. 2 = end, 1 = start
                ...
                else if ((coordinateType == COORD_TYPE_END) && (isPenDown)) {
